...
description: らいけんの登壇スライドに載せる図・構成図・挿絵の作り方。情報量の絞り方、laiken-light の配色でのSVGの描き方（箱・矢印・帯のパターン）、文字サイズの下限（24pt）、挿絵の置き方、書き出し後の検査。「図を作って」「構成図を描いて」「図が見づらい」「挿絵を入れて」と言われたら読む。
---
